...
namespace SWP391_BL3.API.Controllers
{
    ...
    public class FacilityTypeController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Create([FromBody] FacilityTypeRequest facilityTypeRequest)
        {
        ...
        [HttpPut]
        public IActionResult Update(int id, [FromBody] FacilityTypeRequest facilityTypeRequest)
        {
